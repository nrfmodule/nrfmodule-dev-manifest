...
# cppcheck: ENFORCED where installed (CI lint, apt install cppcheck), skipped
# with a notice elsewhere. No build dir needed.
bash "$CHECKS_DIR/cppcheck.sh"               "${files[@]}" || fail=1
